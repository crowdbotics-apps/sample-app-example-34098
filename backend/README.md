...
## Project Structure
    ...
    ├── sample_app_example_34098  # Django project configurations
...
1. Clone this repo and `cd sample_app_example_34098`
...
2. Clone this repo and `cd sample_app_example_34098`
